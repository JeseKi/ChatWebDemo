...
- python scripts/init_db.py           # 迁移到最新版本并引导业务数据
"""
...
from src.server.database import bootstrap_database_data, get_database_info, engine

PROJECT_ROOT = Path(__file__).parent.parent


def upgrade_database() -> None:
    """执行 Alembic 迁移并初始化幂等业务数据。"""
